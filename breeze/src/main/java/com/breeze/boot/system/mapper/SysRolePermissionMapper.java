 ...
 */
@Mapper
public interface SysRolePermissionMapper extends BreezeBaseMapper<SysRolePermission> {
     ...
     */
    List<SysPermission> listRolePermissionByRoleIds(@Param("roleIdSet") Set<Long> roleIdSet);
