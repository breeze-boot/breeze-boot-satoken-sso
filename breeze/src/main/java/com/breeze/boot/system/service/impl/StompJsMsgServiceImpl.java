...
public class StompJsMsgServiceImpl extends WebSocketMsgService {
     ...
     */
    private void toAsyncSendMsg(SysMsg sysMsg, List<UserMsgBO.MsgBodyBO> sysUserMsgBOList) {
        UserMsgBO userMsgBO = new UserMsgBO();
        userMsgBO.setMsgBodyBOList(sysUserMsgBOList);
