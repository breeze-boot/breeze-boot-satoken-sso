...
import com.breeze.boot.system.vo.TokenSettingsVO;
...
@Slf4j
@Service
    public class SysRegisterClientServiceImpl extends ServiceImpl<SysRegisterClientMapper, SysRegisteredClient> implements SysRegisterClientService {
