...
import com.breeze.boot.auth.authentication.email.EmailAuthenticationProvider;
import com.breeze.boot.auth.authentication.email.OAuth2ResourceOwnerEmailAuthenticationConverter;
import com.breeze.boot.auth.authentication.email.OAuth2ResourceOwnerEmailAuthenticationProvider;
import com.breeze.boot.auth.authentication.password.OAuth2ResourceOwnerPasswordAuthenticationConverter;
import com.breeze.boot.auth.authentication.password.OAuth2ResourceOwnerPasswordAuthenticationProvider;
import com.breeze.boot.auth.authentication.sms.OAuth2ResourceOwnerSmsAuthenticationConverter;
import com.breeze.boot.auth.authentication.sms.OAuth2ResourceOwnerSmsAuthenticationProvider;
import com.breeze.boot.auth.authentication.sms.SmsAuthenticationProvider;
import com.breeze.boot.auth.extend.*;
import com.breeze.boot.auth.jose.Jwks;
...
public class AuthorizationServerConfiguration {
     ...
     */
    @Bean
    public RegisteredClientRepository registeredClientRepository(SysRegisterClientService registerClientService) {
        return new RemoteRegisterClientService(registerClientService);
    }
