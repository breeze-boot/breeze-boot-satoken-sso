...
import com.breeze.boot.auth.utils.OAuth2EndpointUtils;
...
public class RemoteRegisterClientService implements RegisteredClientRepository {
     ...
     * 注册客户端装
     */
    private final SysRegisterClientService registerClientService;
     ...
     */
    public RemoteRegisterClientService(SysRegisterClientService registerClientService) {
    ...
    public RegisteredClient findById(String id) {
        SysRegisteredClient registeredClient = registerClientService.getById(id);
    ...
    public RegisteredClient findByClientId(String clientId) {
        SysRegisteredClient registeredClient = registerClientService.getByClientId(clientId);
        return buildRegisteredClient(registeredClient);
    }
