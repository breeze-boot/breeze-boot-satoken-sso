...
import com.breeze.boot.auth.constants.CustomAuthorizationGrantType;
...
public class CustomAuthenticationEntryPoint extends LoginUrlAuthenticationEntryPoint {
    ...
    public CustomAuthenticationEntryPoint(String loginFromUrl) {
        super(loginFromUrl);
    }
    ...
    public void commence(HttpServletRequest request, HttpServletResponse response, AuthenticationException e) {
        ...
        if (StrUtil.isAllBlank(grantType)
                || !CustomAuthorizationGrantType.getGrantTypes().contains(grantType)) {
