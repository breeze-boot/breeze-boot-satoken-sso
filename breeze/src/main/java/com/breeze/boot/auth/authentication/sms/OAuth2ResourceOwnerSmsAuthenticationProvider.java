...
package com.breeze.boot.auth.authentication.sms;
...
import static com.breeze.boot.auth.constants.CustomAuthorizationGrantType.SMS_CODE;
import static com.breeze.boot.auth.constants.CustomOAuth2ParameterNames.CODE;
import static com.breeze.boot.auth.constants.CustomOAuth2ParameterNames.PHONE;
...
public class OAuth2ResourceOwnerSmsAuthenticationProvider extends OAuth2ResourceOwnerAuthenticationProvider {
    ...
    public OAuth2ResourceOwnerSmsAuthenticationProvider(OAuth2AuthorizationService authorizationService,
        ...
        super(authorizationService, tokenGenerator, SMS_CODE, resourceOwnerAuthentication(authenticationManager));
    }
    ...
    private static Function<OAuth2ResourceOwnerAuthenticationToken, Authentication> resourceOwnerAuthentication(AuthenticationManager authenticationManager) {
        return (resourceOwnerAuthentication) -> {
            ...
            SmsAuthenticationToken smsAuthenticationToken = new SmsAuthenticationToken(phone, code);
            log.debug("got smsAuthenticationToken=" + smsAuthenticationToken);
