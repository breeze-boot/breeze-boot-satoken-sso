...
@TableName(value = "sys_menu_column", autoResultMap = true)
@Schema(description = "系统菜单列实体")
public class SysMenuColumn extends Model<SysMenuColumn> implements Serializable {
