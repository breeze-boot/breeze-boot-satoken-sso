...
package com.breeze.boot.jwtlogin.email;
...
public class EmailCodeAuthenticationProvider implements AuthenticationProvider {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        CurrentLoginUser currentLoginUser = this.getUserDetailsService().loadUserByEmail((String) authenticationToken.getPrincipal());
        ...
        EmailCodeAuthenticationToken emailCodeAuthenticationToken = new EmailCodeAuthenticationToken(currentLoginUser, currentLoginUser.getAuthorities());
        emailCodeAuthenticationToken.setDetails(currentLoginUser);
