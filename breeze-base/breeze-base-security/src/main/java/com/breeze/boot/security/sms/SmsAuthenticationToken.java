...
public class SmsAuthenticationToken extends AbstractAuthenticationToken {
     ...
     * 未经身份验证
     * <p>
     * This factory method can be safely used by any code that wishes to create a unauthenticated <code>SmsAuthenticationToken</code>.
     *
     * @param principal   主要
     * @param credentials 凭证
     ...
     * 通过身份验证
     * <p>
     * This factory method can be safely used by any code that wishes to create a authenticated <code>SmsAuthenticationToken</code>.
     *
     * @param principal   主要
     * @param credentials 凭证
     * @param authorities 当局
