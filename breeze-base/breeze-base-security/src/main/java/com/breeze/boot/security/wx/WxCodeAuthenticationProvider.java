...
public class WxCodeAuthenticationProvider implements AuthenticationProvider {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        WxLoginParam wxLoginParam = (WxLoginParam) authenticationToken.getPrincipal();
        String openId = WxHttpInterfaceUtils.getOpenId(this.wxLoginProperties.getAppId(), this.wxLoginProperties.getAppSecret(), wxLoginParam.getCode());
        wxLoginParam.setOpenId(openId);
        UserDetails userDetails = this.userDetailsService.createOrLoadUser(wxLoginParam);
